...
def build_chat_prompt(question: str, rag_docs: list[str], web_docs: list[str], conversation_history: List[Dict[str, str]] = None) -> str:
    parts = [
...
def chat_answer_with_context(question: str, conversation_history: List[Dict[str, str]] = None) -> Dict[str, Any]:
    """Enhanced chat answer with conversation history context"""
    llm, _ = get_llm_and_embeddings()
    ...
    prompt = build_chat_prompt(question, rag_docs, web_docs, conversation_history)
    answer_text = llm(prompt)
